-- Separately operated Retrieval maintenance phase.
-- Preconditions: migration 0039 is committed and the operator holds the
-- maintenance advisory lock used by the companion runner.
