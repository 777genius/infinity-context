"""Trusted provider-neutral capability values for locator Retrieval V2."""

from __future__ import annotations

from dataclasses import dataclass

LOCATOR_RETRIEVAL_ENDPOINT_V2 = "/v1/context/retrieve"
LOCATOR_RETRIEVAL_ATTRIBUTE_SCHEMA_V2 = "document-retrieval-projection.v1"
LOCATOR_RETRIEVAL_COVERAGE_V2 = "top_k_only"
LOCATOR_RETRIEVAL_RANKING_POLICY_V2 = "weighted_rrf_canonical_preferences.v1"
LOCATOR_RETRIEVAL_RANK_CONSTANT_V2 = 60
LOCATOR_RETRIEVAL_WEIGHT_SCALE_MICROS_V2 = 1_000_000
LOCATOR_RETRIEVAL_SCORE_SCALE_PICOS_V2 = 1_000_000_000_000
LOCATOR_RETRIEVAL_PREFERENCE_SCALE_MICROS_V2 = 1_000_000
LOCATOR_RETRIEVAL_MAX_PREFERENCE_BOOST_MICROS_V2 = 250_000
LOCATOR_RETRIEVAL_CONTRIBUTION_ROUNDING_V2 = "round_half_even"
LOCATOR_RETRIEVAL_PREFERENCE_ROUNDING_V2 = "floor"
LOCATOR_RETRIEVAL_SIGNAL_MATCH_POLICY_V2 = "canonical_exact_key_interval_overlap.v1"
LOCATOR_RETRIEVAL_HARD_FILTER_SIGNALS_V2 = (
    "actor_keys",
    "category",
    "document_keys",
...
LOCATOR_RETRIEVAL_SOFT_PREFERENCE_SIGNALS_V2 = (
    "actor_preferences",
    "relative_time_interval",
    "source_preferences",
    "time_interval",
...
class LocatorRetrievalCapabilityBoundsV2:
    ...
    def __post_init__(self) -> None:
        ...
        if actual != canonical:
            raise ValueError("Locator capability bounds must match Retrieval V2")


@dataclass(frozen=True, slots=True)
class LocatorProviderLaneCapabilityV2:
    provider_id: str
    required: bool
    healthy: bool
    weight_micros: int
...
@dataclass(frozen=True, slots=True)
class LocatorRankingParametersV2:
    rank_constant: int = LOCATOR_RETRIEVAL_RANK_CONSTANT_V2
    weight_scale_micros: int = LOCATOR_RETRIEVAL_WEIGHT_SCALE_MICROS_V2
    score_scale_picos: int = LOCATOR_RETRIEVAL_SCORE_SCALE_PICOS_V2
    preference_scale_micros: int = LOCATOR_RETRIEVAL_PREFERENCE_SCALE_MICROS_V2
    max_preference_boost_micros: int = LOCATOR_RETRIEVAL_MAX_PREFERENCE_BOOST_MICROS_V2
    contribution_rounding: str = LOCATOR_RETRIEVAL_CONTRIBUTION_ROUNDING_V2
    preference_rounding: str = LOCATOR_RETRIEVAL_PREFERENCE_ROUNDING_V2
    canonical_signal_match_policy: str = LOCATOR_RETRIEVAL_SIGNAL_MATCH_POLICY_V2
    ...
    def __post_init__(self) -> None:
        ...
        if actual != expected:
            raise ValueError("Locator ranking parameters must match Retrieval V2")


@dataclass(frozen=True, slots=True)
class LocatorRetrievalCapabilityV2:
    ...
    provider_lanes: tuple[LocatorProviderLaneCapabilityV2, ...] = ()
    endpoint: str = LOCATOR_RETRIEVAL_ENDPOINT_V2
    contract_version: str = "context-retrieval.v2"
    ranking_policy: str = LOCATOR_RETRIEVAL_RANKING_POLICY_V2
    ranking_parameters: LocatorRankingParametersV2 = LocatorRankingParametersV2()
    attribute_schema: str = LOCATOR_RETRIEVAL_ATTRIBUTE_SCHEMA_V2
    coverage: str = LOCATOR_RETRIEVAL_COVERAGE_V2
    bounds: LocatorRetrievalCapabilityBoundsV2 = LocatorRetrievalCapabilityBoundsV2()
    hard_filter_signals: tuple[str, ...] = LOCATOR_RETRIEVAL_HARD_FILTER_SIGNALS_V2
    soft_preference_signals: tuple[str, ...] = LOCATOR_RETRIEVAL_SOFT_PREFERENCE_SIGNALS_V2
    ...
    def __post_init__(self) -> None:
        ...
        if self.endpoint != LOCATOR_RETRIEVAL_ENDPOINT_V2:
        ...
        if not isinstance(self.ranking_parameters, LocatorRankingParametersV2):
            raise ValueError("Locator capability ranking_parameters has an invalid type")
        object.__setattr__(self, "ranking_parameters", LocatorRankingParametersV2())
        if self.attribute_schema != LOCATOR_RETRIEVAL_ATTRIBUTE_SCHEMA_V2:
            raise ValueError("Locator capability attribute_schema is unsupported")
        if self.coverage != LOCATOR_RETRIEVAL_COVERAGE_V2:
            raise ValueError("Locator capability coverage is unsupported")
        if not isinstance(self.bounds, LocatorRetrievalCapabilityBoundsV2):
            raise ValueError("Locator capability bounds have an invalid type")
        bounds = LocatorRetrievalCapabilityBoundsV2(
        ...
        if ids != tuple(sorted(set(ids), key=canonical_string_sort_key_v2)) or len(lanes) > 4:
        ...
        if hard != LOCATOR_RETRIEVAL_HARD_FILTER_SIGNALS_V2:
            raise ValueError("Locator capability hard filter signals are unsupported")
        if soft != LOCATOR_RETRIEVAL_SOFT_PREFERENCE_SIGNALS_V2:
...
def canonical_string_sort_key_v2(value: str) -> bytes:
...
__all__ = (
    "LOCATOR_RETRIEVAL_ATTRIBUTE_SCHEMA_V2",
    "LOCATOR_RETRIEVAL_COVERAGE_V2",
    "LOCATOR_RETRIEVAL_ENDPOINT_V2",
    "LOCATOR_RETRIEVAL_HARD_FILTER_SIGNALS_V2",
