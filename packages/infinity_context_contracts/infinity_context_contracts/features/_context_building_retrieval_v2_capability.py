"""Canonical capability contract and fingerprint policy for Retrieval V2."""
...
from ._context_building_retrieval_v2_json import (
    _normalize_context_retrieval_v2_unicode,
    decode_context_retrieval_v2_json,
)
from ._context_building_retrieval_v2_validation import canonical_string_sort_key

CAPABILITY_ENDPOINT_V2 = "/v1/context/retrieve"
CAPABILITY_ATTRIBUTE_SCHEMA_V2 = "document-retrieval-projection.v1"
CAPABILITY_COVERAGE_V2 = "top_k_only"
CAPABILITY_CONTRACT_VERSION_V2 = "context-retrieval.v2"
CAPABILITY_RANKING_POLICY_V2 = "weighted_rrf_canonical_preferences.v1"
...
class RetrievalV2CapabilityBoundsDto:
    ...
    def __post_init__(self) -> None:
        ...
        if actual != canonical:
            raise ValueError("capability.bounds does not match Retrieval V2")
    ...
    @classmethod
    def from_dict(cls, payload: Mapping[str, object]) -> RetrievalV2CapabilityBoundsDto:
...
@dataclass(frozen=True, slots=True)
class RetrievalV2ProviderLaneCapabilityDto:
    provider_id: str
    required: bool
    healthy: bool
    weight_micros: int
    ...
    @classmethod
    def from_dict(cls, payload: Mapping[str, object]) -> RetrievalV2ProviderLaneCapabilityDto:
        _exact_keys(
            payload,
...
@dataclass(frozen=True, slots=True)
class RetrievalV2RankingParametersDto:
    ...
    def __post_init__(self) -> None:
        if self.to_dict() != RetrievalV2RankingParametersDto._canonical():
            raise ValueError("capability.ranking_parameters does not match Retrieval V2")
    ...
    @classmethod
    def from_dict(cls, payload: Mapping[str, object]) -> RetrievalV2RankingParametersDto:
...
@dataclass(frozen=True, slots=True)
class RetrievalV2CapabilityDto:
    capability_fingerprint: str
    profile_id: str
    service_revision: str
    index_profile_digest: str
    provider_lanes: Sequence[RetrievalV2ProviderLaneCapabilityDto]
    endpoint: str = CAPABILITY_ENDPOINT_V2
    contract_version: str = CAPABILITY_CONTRACT_VERSION_V2
    ranking_policy: str = CAPABILITY_RANKING_POLICY_V2
    ranking_parameters: RetrievalV2RankingParametersDto = RetrievalV2RankingParametersDto()
    attribute_schema: str = CAPABILITY_ATTRIBUTE_SCHEMA_V2
    coverage: str = CAPABILITY_COVERAGE_V2
    supports_neighbors: bool = True
    bounds: RetrievalV2CapabilityBoundsDto = RetrievalV2CapabilityBoundsDto()
    hard_filter_signals: Sequence[str] = CAPABILITY_HARD_FILTER_SIGNALS_V2
    soft_preference_signals: Sequence[str] = CAPABILITY_SOFT_PREFERENCE_SIGNALS_V2
    ...
    def __post_init__(self) -> None:
        ...
        if self.endpoint != CAPABILITY_ENDPOINT_V2:
            raise ValueError("capability.endpoint is unsupported")
        if self.contract_version != CAPABILITY_CONTRACT_VERSION_V2:
            raise ValueError("capability.contract_version is unsupported")
        if self.ranking_policy != CAPABILITY_RANKING_POLICY_V2:
            raise ValueError("capability.ranking_policy is unsupported")
        if not isinstance(self.ranking_parameters, RetrievalV2RankingParametersDto):
            raise ValueError("capability.ranking_parameters has an invalid type")
        ranking_parameters = RetrievalV2RankingParametersDto.from_dict(
            self.ranking_parameters.to_dict()
        )
        object.__setattr__(self, "ranking_parameters", ranking_parameters)
        if self.attribute_schema != CAPABILITY_ATTRIBUTE_SCHEMA_V2:
            raise ValueError("capability.attribute_schema is unsupported")
        if self.coverage != CAPABILITY_COVERAGE_V2 or not isinstance(self.supports_neighbors, bool):
            raise ValueError("capability coverage or neighbor support is unsupported")
        if not isinstance(self.bounds, RetrievalV2CapabilityBoundsDto):
            raise ValueError("capability.bounds has an invalid type")
        bounds = RetrievalV2CapabilityBoundsDto.from_dict(self.bounds.to_dict())
        lanes = tuple(
            ...
            if isinstance(lane, RetrievalV2ProviderLaneCapabilityDto)
        )
        ...
        if hard != CAPABILITY_HARD_FILTER_SIGNALS_V2:
            raise ValueError("capability.hard_filter_signals is unsupported")
        if soft != CAPABILITY_SOFT_PREFERENCE_SIGNALS_V2:
        ...
        if self.capability_fingerprint != capability_fingerprint_v2(self.to_dict()):
    ...
    @classmethod
    def from_dict(cls, payload: Mapping[str, object]) -> RetrievalV2CapabilityDto:
        ...
        return cls(
            ...
            provider_lanes=tuple(
                RetrievalV2ProviderLaneCapabilityDto.from_dict(item) for item in lanes
            ),
            ...
            ranking_parameters=RetrievalV2RankingParametersDto.from_dict(ranking_parameters),
            ...
            bounds=RetrievalV2CapabilityBoundsDto.from_dict(bounds),
...
def capability_fingerprint_v2(payload: Mapping[str, object]) -> str:
    normalized = _normalize_context_retrieval_v2_unicode(payload)
...
def decode_retrieval_v2_capability(raw: bytes) -> RetrievalV2CapabilityDto:
    return RetrievalV2CapabilityDto.from_dict(decode_context_retrieval_v2_json(raw))
