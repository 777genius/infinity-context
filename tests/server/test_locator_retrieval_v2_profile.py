...
def _request(fingerprint: str, profile: str) -> core.LocatorRetrievalRequestV2:
    return core.LocatorRetrievalRequestV2(
        "context-retrieval.v2",
        fingerprint,
        profile,
        core.LocatorRetrievalScopeV2("space", "scope"),
        (core.LocatorQueryVariantV2("q1", "query"),),
        ...
        core.LocatorRetrievalBoundsV2(candidate_limit=1, result_limit=1),
    )
...
class _CountingProvider:
    ...
    async def retrieve_locator_candidates(self, request):
        self.calls += 1
        return core.LocatorProviderResultV2(status="available")
