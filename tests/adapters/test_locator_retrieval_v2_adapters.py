...
def _request() -> core.LocatorRetrievalRequestV2:
    interval = core.LocatorTimeIntervalV2(
    ...
    return core.LocatorRetrievalRequestV2(
        ...
        "a" * 64,
        "profile",
        core.LocatorRetrievalScopeV2("space", "scope", "thread"),
        (core.LocatorQueryVariantV2("q1", "bounded query"),),
        core.LocatorHardFiltersV2(
            source_generations=(core.LocatorSourceGenerationV2("source", "generation"),),
        ...
        core.LocatorRetrievalBoundsV2(candidate_limit=10, result_limit=5),
    )
...
def test_qdrant_filter_preserves_null_thread_scope_exactly() -> None:
    request = replace(_request(), scope=core.LocatorRetrievalScopeV2("space", "scope"))
