...
MANAGED_V5_REQUESTED_OUTPUT_TOKENS_PER_CALL = 4_096
MANAGED_V5_FULL_ANSWER_JUDGE_CALL_COUNT = 8_160
MANAGED_V5_FULL_ANSWER_JUDGE_REQUESTED_OUTPUT_TOKEN_RESERVATION = (
    MANAGED_V5_FULL_ANSWER_JUDGE_CALL_COUNT * MANAGED_V5_REQUESTED_OUTPUT_TOKENS_PER_CALL
)
_MAX_ANSWER_JUDGE_TOKENS = MANAGED_V5_FULL_ANSWER_JUDGE_REQUESTED_OUTPUT_TOKEN_RESERVATION
