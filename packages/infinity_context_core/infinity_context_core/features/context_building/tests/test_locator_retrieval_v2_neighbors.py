"""Order-independent radius-two neighbor regressions for Retrieval V2."""
...
def test_radius_two_is_complete_under_shuffle_and_shared_neighbor_has_one_owner() -> None:
    ...
    for shuffle_seed in range(20):
        ...
        provider = LocatorProviderRegistrationV2(
        ...
        response = asyncio.run(
            ...
            ).execute(_request(bounds=LocatorRetrievalBoundsV2(result_limit=2, neighbor_radius=2)))
        )
