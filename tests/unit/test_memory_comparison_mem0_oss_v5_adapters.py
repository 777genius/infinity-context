...
def _receipt_at(
    ...
    return RuntimeReceiptVerificationResult(
        ...
        sequence=unit_index,
        request_body_sha256=_digest(f"request-{unit_index}"),
        output_text_sha256=_digest(f"output-{unit_index}"),
        runtime_binding_commitment_sha256=_digest("runtime-binding"),
...
def _receipt(
    ...
    *,
    ...
    return RuntimeReceiptVerificationResult(
        ...
        sequence=0,
        request_body_sha256=_digest("request-body"),
        output_text_sha256=_digest("output-text"),
        runtime_binding_commitment_sha256=_digest("runtime-binding"),
