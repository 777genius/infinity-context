...
EXPANSION_RULES_PART_5: tuple[tuple[frozenset[str], str, str], ...] = (
    ...
    *WORKFLOW_EXPANSION_RULES,
    ...
    (
            frozenset({"obsolete"}),
            "stale obsolete deprecated outdated old superseded replaced previous not current"
            " review",
            "stale_state_temporal_bridge",
        ),
    (
    ...
    (
            frozenset({"expired"}),
            "expired stale outdated superseded replaced previous no longer valid not current"
            " review",
            "stale_state_temporal_bridge",
        ),
    (
