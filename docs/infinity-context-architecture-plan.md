...
| Locator retrieval | Retrieval and Context Packing, Canonical Visibility and Read-Path Guard Model, ADR-0011 | only opaque locators and bounded retrieval provenance cross Retrieval; canonical hydration remains lifecycle authority |
