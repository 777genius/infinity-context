"""Package-owned qualification policy and preregistered Retrieval anchors."""
...
def _binding_issues(binding: QualificationBinding, current_digest: str) -> tuple[str, ...]:
    ...
    if binding.contract_version != LOCATOR_RETRIEVAL_CONTRACT_VERSION:
        issues.append("drift:contract_version")
    if binding.ranking_policy != LOCATOR_RETRIEVAL_RANKING_POLICY:
