...
RETRIEVAL_V2_EVALUATION_SCHEMA = "locator-retrieval-v2-evaluation.v1"
_MANIFEST_FIELDS = {
    "binding",
    "component_digests",
    "dataset",
...
def verify_evaluation_evidence(evidence: EvaluationEvidence) -> EvaluationEvidence:
    ...
    if root["schema_version"] != RETRIEVAL_V2_EVALUATION_SCHEMA:
...
def _manifest(dataset, observations, binding, profile, metrics, qualification, spec_id):
    ...
    return {
        ...
        "qualification_spec_id": spec_id,
        "schema_version": RETRIEVAL_V2_EVALUATION_SCHEMA,
    }
...
__all__ = (
    "EvaluationEvidence",
    "RETRIEVAL_V2_EVALUATION_SCHEMA",
