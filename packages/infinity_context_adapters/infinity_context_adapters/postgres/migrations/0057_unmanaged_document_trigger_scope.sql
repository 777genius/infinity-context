-- Keep protected strict-v4 capability checks inside registered benchmark paths.
...
DECLARE
    ...
    canonical_writer BOOLEAN := FALSE;
BEGIN
    ...
    IF pg_catalog.pg_has_role(
        current_user, 'infinity_context_canonical_writer', 'MEMBER'
    ) THEN
        canonical_writer := public.memory_comparison_is_strict_v4_canonical_writer();
    END IF;
