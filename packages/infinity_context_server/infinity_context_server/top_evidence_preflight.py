...
from infinity_context_server import top_evidence_dataset_profile as _dataset_profiles
...
from infinity_context_server.llm_provider_readiness import (
    evaluate_llm_provider_readiness,
)
...
_profile_str = _dataset_profiles._profile_str
...
def run_top_evidence_preflight(
    *,
    ...
    llm_readiness = evaluate_llm_provider_readiness(env)
    checks["llm_provider_ready"] = llm_readiness.ready
    _append_failure(
        checks,
        failures,
        "llm_provider_ready",
        llm_readiness.failure_reason
        or "Configure a live LLM provider before running top evidence",
    )
